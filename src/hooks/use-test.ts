...
//   const { timerId, startTime, startTimer } = useTimerStore();
...
//   const start = async (goal: string, tasks: Task[]) => {
...
//       startTimer(goal, tasks, data.timerId, data.studyLogId, data.startTime);
//     } catch (error) {
